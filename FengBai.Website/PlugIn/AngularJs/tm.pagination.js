...
angular.module('tm.pagination', []).directive('tmPagination', [function () {
    return {
        ...
        template: '<div class="page-list">' +
            ...
            '<div style="float:left;margin-left:20px;margin-top:5px;" class="page-total" ng-show="conf.totalItems > 0">' +
            '第<input type="text" style="width:40px" ng-model="jumpPageNum"  ng-keyup="jumpToPage($event)"/>页 ' +
